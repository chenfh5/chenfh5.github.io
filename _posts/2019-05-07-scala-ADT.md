...
![sealed自身及其子类只能在同一.scala文件下被继承](https://upload-images.jianshu.io/upload_images/2189341-eff77c77cc09dddb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
> sealed自身及其子类只能在同一.scala文件下被继承
