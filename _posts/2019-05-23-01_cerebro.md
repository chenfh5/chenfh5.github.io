...
![代码划分](https://upload-images.jianshu.io/upload_images/2189341-ad0a062bfa1d81f6.png)
> 代码划分
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-2c3b6a522ad136de.png)
- 登入之后，`navbar.html`，主要分为4个tab(overview, nodes, rest, more)
![image.png](https://upload-images.jianshu.io/upload_images/2189341-56fa2b3d5c248182.png)
    - `overview.html`
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-c5e21202dad34377.png)
    - `nodes.index.html`
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-26b7d22fed8ec52d.png)
    - `rest.index.html`
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-27199a5cc6091f3a.png)
    - `more`
    ![more下面的第一栏create index](https://upload-images.jianshu.io/upload_images/2189341-da4e93068a518998.png)
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-7232a35c5285f3b3.png)
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-2a02d5b9cad235fb.png)
> js层级结构
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-9488b82e0a6011a3.png)
> 输入localhost:9000/之后，redirectTo到localhost:9000/#/connect

![image.png](https://upload-images.jianshu.io/upload_images/2189341-47b34fd661d761a9.png)
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-db5b5080c842cd62.png)
> 调用ConnectDataService.connect(host);

![image.png](https://upload-images.jianshu.io/upload_images/2189341-407c493a82a1e50e.png)
> 具体是发送`_cluster/health`到es rest

![image.png](https://upload-images.jianshu.io/upload_images/2189341-abeb782b52949db4.png)
> 返回的resp

![image.png](https://upload-images.jianshu.io/upload_images/2189341-55475e42e1540063.png)
> 然后开始在`overview.html`里面渲染

![image.png](https://upload-images.jianshu.io/upload_images/2189341-24de4fff3b0720ff.png)
> 首先resp渲染到`static.html`

![image.png](https://upload-images.jianshu.io/upload_images/2189341-c48198986b780188.png)
> 另外resp.status这个变量是通过page.js展示到document里的

至此完成了`overview.html`的第一部分内容渲染，还剩的**nodes区**和**index区**。

![image.png](https://upload-images.jianshu.io/upload_images/2189341-cab507cc77d11998.png)
> overview.html的分区

![image.png](https://upload-images.jianshu.io/upload_images/2189341-ca713a56049358db.png)
> node区和index区的骨架
