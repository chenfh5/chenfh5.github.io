...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-be8d0e11aabb8730.png)
> 安装后的snapshot

# 配置
因为默认的配置和主题不是很match自己的style，所以做出了以下改动，
1. 更换主题
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-53d85d82f49c0155.png)
2. 更换和添加快捷键
    - [跳词](https://stackoverflow.com/a/16411270/9108627)
        ...
        ```
        ![image.png](https://upload-images.jianshu.io/upload_images/2189341-29707f99fefe60f8.png)
    - [删除词](https://coderwall.com/p/ds2dha/word-line-deletion-and-navigation-shortcuts-in-iterm2) && 前后翻tab
        ![image.png](https://upload-images.jianshu.io/upload_images/2189341-7fc02b703316382d.png)
3. vim默认开启[语法高亮](https://www.codexpedia.com/text-editor/turn-on-syntax-highlighting-for-vim-on-mac-os/)
    ...
    3. add below to .vimrc
        ...
        syntax on
        ```
        ![image.png](https://upload-images.jianshu.io/upload_images/2189341-df52452e031c35b8.png)
4. 保存并恢复指定[会话窗口](https://apple.stackexchange.com/a/25084)，避免一直cd
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-d3b56706fd6f11d7.png)
