...
今天刚好再公众号里面看到介绍的[Aloha](https://github.com/jrthe42/aloha)，而且还是scala写的，之前看的[Oozie](https://github.com/apache/oozie)和jobnavi都是java写的。那么看看这个Aloha是如何工作的，一步一步分解她的各个模块和工作流程，力求之后自己能够独立写出一个分布式调度器来 :)
...
- 启动master web server，并开始监听
    ...
    ![image.png](https://upload-images.jianshu.io/upload_images/2189341-7176a8f556195e2b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/2189341-b5dc9ae69185af0d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
> rest urls
